...
require (
	...
	github.com/gardener/landscaper-utils/deployutils v0.0.0-20211104151042-e8eeda1247ec
	github.com/gardener/landscaper-utils/machineimages v0.0.0-20211104151042-e8eeda1247ec
