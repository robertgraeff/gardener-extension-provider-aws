...
require (
	...
	github.com/gardener/landscaper-utils/deployutils v0.0.0-20211109085447-6f2d6c915d44
	github.com/gardener/landscaper-utils/machineimages v0.0.0-20211109085447-6f2d6c915d44
