...
require (
	...
	github.com/gardener/landscaper-utils/deployutils   v0.0.0-20211109143531-a199b485b196
	github.com/gardener/landscaper-utils/machineimages v0.0.0-20211109143531-a199b485b196
