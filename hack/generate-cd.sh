...
IMAGE_REGISTRY="eu.gcr.io/gardener-project/gardener/extensions"
CD_REGISTRY="eu.gcr.io/sap-se-gcr-k8s-private/cnudie/gardener/development"
...
---
type: ociImage
name: gardener-extension-provider-aws-deployer
relation: local
access:
  type: ociRegistry
  imageReference: ${IMAGE_REGISTRY}/provider-aws/deployer:${EFFECTIVE_VERSION}
...
---
type: ociImage
name: alpine
